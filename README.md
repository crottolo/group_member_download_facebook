...
````
### questo è un adattamento del codice originale che potete trovare qui:

[repo originale](https://github.com/floriandiud/facebook-group-members-scraper?tab=readme-ov-file)
